...
ngx_http_vod_create_loc_conf(ngx_conf_t *cf)
{
	...
	conf->try_suburis_middles = NGX_CONF_UNSET_PTR;
...
ngx_http_vod_merge_loc_conf(ngx_conf_t *cf, void *parent, void *child)
{
	...
	ngx_conf_merge_str_value(conf->try_suburis_postfix, prev->try_suburis_postfix, "");
	ngx_conf_merge_ptr_value(conf->try_suburis_middles, prev->try_suburis_middles, NULL);

	if (conf->manifest_urls_args == NULL)
	{
		conf->manifest_urls_args = prev->manifest_urls_args;
	}
...
ngx_command_t ngx_http_vod_commands[] = {
	...
	{ ngx_string("vod_try_suburis_middles"),
	NGX_HTTP_MAIN_CONF | NGX_HTTP_SRV_CONF | NGX_HTTP_LOC_CONF | NGX_CONF_ANY,
	ngx_http_vod_try_suburis_middle_command,
	NGX_HTTP_LOC_CONF_OFFSET,
	offsetof(ngx_http_vod_loc_conf_t, try_suburis_middles),
	NULL },

	{ ngx_string("vod_try_suburis_postfix"),
	NGX_HTTP_MAIN_CONF | NGX_HTTP_SRV_CONF | NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
	ngx_conf_set_str_slot,
	NGX_HTTP_LOC_CONF_OFFSET,
	offsetof(ngx_http_vod_loc_conf_t, try_suburis_postfix),
	NULL },

	{ ngx_string("vod_manifest_urls_args"),
	NGX_HTTP_MAIN_CONF | NGX_HTTP_SRV_CONF | NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
	ngx_http_set_complex_value_slot,
	NGX_HTTP_LOC_CONF_OFFSET,
	offsetof(ngx_http_vod_loc_conf_t, manifest_urls_args),
	NULL },
